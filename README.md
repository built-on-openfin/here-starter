...
This branch covers version **v10.0** of Here (there are versioned branches for other releases).
...
| [How To Use The Content Configuration API](./how-to/use-content-config-api/)   | This example shows how to manage your application directory programmatically — full create, read, update and delete through a single GraphQL endpoint — with a guided UI that signs in using OAuth 2.0 (authorization code + PKCE) and an FDC3-driven config-as-code sync script.  |
