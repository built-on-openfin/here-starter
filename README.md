...
| [How To Use The Content Configuration API](./how-to/use-content-config-api/)   | This example shows how to manage your application directory programmatically — full create, read, update and delete through a single GraphQL endpoint — with a guided UI and an FDC3-driven config-as-code sync script.  |
